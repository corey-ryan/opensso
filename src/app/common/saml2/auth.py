...
from app.common.saml2 import compat
from app.common.saml2.settings import OneLogin_Saml2_Settings
from app.common.saml2.response import OneLogin_Saml2_Response
from app.common.saml2.logout_response import OneLogin_Saml2_Logout_Response
from app.common.saml2.constants import OneLogin_Saml2_Constants
from app.common.saml2.utils import OneLogin_Saml2_Utils, OneLogin_Saml2_Error, OneLogin_Saml2_ValidationError
from app.common.saml2.logout_request import OneLogin_Saml2_Logout_Request
from app.common.saml2.authn_request import OneLogin_Saml2_Authn_Request
...
class OneLogin_Saml2_Auth(object):
    ...
    def __init__(self, request_data, old_settings=None, target_app=None, role=None, custom_base_path=None):
        """
        Initializes the SP SAML instance.
        ...
        """
        self.__target_app = target_app
        self.__role = role
        self.__request_data = request_data
        if isinstance(old_settings, OneLogin_Saml2_Settings):
            self.__settings = old_settings
        else:
            self.__settings = OneLogin_Saml2_Settings(old_settings, custom_base_path, target_app=self.__target_app, role=self.__role)
