...
from app.common.saml2.errors import OneLogin_Saml2_Error
from app.common.saml2.metadata import OneLogin_Saml2_Metadata
from app.common.saml2.utils import OneLogin_Saml2_Utils
from app.common.saml2.xml_utils import OneLogin_Saml2_XML
...
class OneLogin_Saml2_Settings(object):
    ...
    def __init__(self, settings=None, custom_base_path=None, sp_validation_only=False, target_app=None, role=None):
        """
        ...
        if settings is None:
            try:
                valid = self.__load_settings_from_file(target_app, role)
    ...
    def __load_settings_from_file(self, target_app, role):
        """
        ...
        :rtype: boolean
        """
        filename = self.get_base_path() + target_app + '/' + role + '.json'
